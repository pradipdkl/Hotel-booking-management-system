                ...
                <div class="login-form-1">
                    ...
                    <form method="POST" action="../Controller/AdminLoginController.php">
                        <div class="form-group">
                            <input type="text" name="username" class="form-control" placeholder="Admin Username*" autocomplete="off" required/>
                        </div>
                        <div class="form-group">
                            <input type="password" name="password" class="form-control" placeholder="Admin Password*" autocomplete="off" required/>
                        </div>
                        <div class="form-group">
